...
import com.cst.growthprocess.UI.viewTipModule.ViewTipModule;
...
public class ListViewActivity extends AppCompatActivity {
    ...
    RelativeLayout mActivityListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this;
        initRecyclerView();
        mTipModule = new ViewTipModule(mContext, mActivityListView, mRecyclerView,
    ...
    private void getDataFromBaidu() {
        ...
        notes.enqueue(new Callback<Notes>() {
            ...
            public void onFailure(Call<Notes> call, Throwable t) {
                ...
                mTipModule.loadFailedWithButton(R.mipmap.tip_without_network,R.string.add_application_failure);
            }
        });
    }
